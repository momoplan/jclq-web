			...
			<%//1.2有昵称则正常跳转回首页 %>
				...
				<dl class="LoginLater">
					<dt>
						...
						<a href="http://www.ruyicai.com/rules/user.html?key=33" target="_blank">
							<%=user.get("t_name") %>
						</a>
					</dt>
					<dd>
						<div class="SelectAccount" onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))"
						onclick="javaScript:window.location.href='http://www.ruyicai.com/rules/user.html?key=23'">
							我的账户
					...
					<dt>
						|<a href="http://www.ruyicai.com/rules/user.html?key=4" target="_blank">充值</a>
						|<a href="http://www.ruyicai.com/rules/user.html?key=11" target="_blank">提款</a>
