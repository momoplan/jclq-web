...
<div class="competing">
		...
		<div class="competingtopCon">
			<div class="competingtopConLogo jclqLogo">
				...
				<dl>
					...
					<a href="rfshengfu.jsp"> <dd class="holdout" >让分胜负</dd></a>
					<a href="shengfucha.jsp"><dd class="holdup">胜负差</dd></a>
	...
	<div class="competingEvent">
		...
		<script> $(function(){
			$.ajax({
				url:"/jclq/SelectDZ.do?loton=shengfucha",//后台处理程序
				type:"POST",//数据发送方式
				...
				<div class="ChannelBuyPannel ChannelBuyCheck">
					...
					<div class="ChannelBuyPannelBody CheckContent">
						<table id="choose_list">
							<tbody><tr><th>序号</th><th colspan="2">客队  VS  主队</th><th>胆</th>
							</tr>
						<tr id="choose_20120302_1"><td><dl onclick="CheckBox($(this));removeThisResult($(this),20120302,1,3,1);" class="CheckBox light Switch"><dt></dt><dd id="no-20120302-1">周一001</dd></dl></td><td colspan="2" id="homeTeam-20120302-1">西明星 vs 东明星</td>
						<td><input name="" type="checkbox" value="" /></td>
						</tr><tr id="choose_20120302_2"><td colspan="4" align="left"><span class="CheckWin selected">客胜21-25</span><span class="CheckLoss selected">客胜21-25</span><span class="CheckLoss selected">客胜21-25</span><span class="CheckLoss selected">客胜21-25</span></td>
						</tr>
						<tr id="choose_20120302_1"><td><dl onclick="CheckBox($(this));removeThisResult($(this),20120302,1,3,1);" class="CheckBox light Switch"><dt></dt><dd id="no-20120302-1">周一001</dd></dl></td><td colspan="2" id="homeTeam-20120302-1">西明星 vs 东明星</td>
						<td><input name="" type="checkbox" value="" /></td>
						</tr><tr id="choose_20120302_2"><td colspan="4"align="left"><span class="CheckWin selected">客胜21-25</span></td>
						</tr></tbody></table>
					</div>
