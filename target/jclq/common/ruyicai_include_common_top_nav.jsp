...
<div class="HeadMiddleLogo">
	...
	<a class="HomeActivityBanner" href="/index.html"><img src="/jclq/images/HomeActivityBanner.jpg" /></a>
 ...
 <div class="HeadBottomMenu">
	<div class="box">
		...
		<ul>
			...
			<li class="ButtonCaseCenter relative"><a href="/hemai/hemaiCenter.html">合买中心</a><!-- <span class="HomePageBGBox ListAwardClass" style="position:absolute; top:3px; left:80px; z-index:110;">合买中心 返奖 </span>--></li>
			<li class="ButtonNumberShow"><a href="/include/kaijianggonggao.html">开奖号码</a></li>
