...
<div class="competing">
		...
		<div class="competingtopCon">
			<div class="competingtopConLogo jclqLogo">
				...
				<dl>
					...
					<a href="daxiaofen.jsp"><dd class="holdup" >大小分</dd></a>
	...
	<div class="competingEvent">
		...
		<script> $(function(){
			$.ajax({
				url:"/jclq/SelectDZ.do?loton=daxiaofen",//后台处理程序
				type:"POST",//数据发送方式
			...
			<form method="post" action="/chlw/user/bet!bettingByDipin" id="BettingForm" name="BettingForm">		
				<div class="ChannelBuyPannel ChannelBuyCheck">
					...
					<div class="ChannelBuyPannelBody CheckContent">
						...
						<td><span onclick="removeThisResult($(this),20120302,1,3,0);" class="CheckWin selected" id="CheckWin-20120302-1">大分</span><span onclick="removeThisResult($(this),20120302,1,0,0)" class="CheckLoss selected" id="CheckLoss-20120302-1">小分</span></td>
						...
						因戈尔
				  </td><td><span class="CheckLoss selected">小分</span><span class="CheckWin selected">大分</span></td>
				  <td><input name="" type="checkbox" value="" /></td>
						...
						杜伊斯
				  </td><td><span class="CheckWin selected">大分</span><span class="CheckLoss selected">小分</span></td>
				  <td><input name="" type="checkbox" value="" /></td>
						</tr></tbody></table>
					</div>
					...
					<div class="ChannelBuyPannelBody CheckSum">
						...
						<br><input name="" type="button" value="确认代购" class="CastBtn"/>
					</div>
				</div>
				<!-- 选号框-->
