	...
	<div class="competingtop">
		...
		<div class="competingtopCon">
			<div class="competingtopConLogo jclqLogo">
				...
				　　<span class="strong">反奖率高达69%，过关固定奖金</span>　　<span>销售时间：周一至周五 09:00～22:45  周六至周日 09:00～00:45</span>
				</div>
				<dl>
					<a href="shengfu.jsp"> <dd class="holdout" >胜负</dd></a>
					<a href="rfshengfu.jsp"> <dd class="holdout" >让分胜负</dd></a>
					<a href="shengfencha.jsp"><dd class="holdup">胜分差</dd></a>
...
<dl class="ChannelBuyRedouble">
	...
	<dd style="width:75px; float:right;">
		...
		<img src="/jclq/images/qkhml.gif" onclick="btn_ClearClick()">
				...
				<input type="hidden" name="lotNo" value="J00007" id="lotNo"/>
				...
				<input type="hidden" value="胜分差" id="dangqianwanfa"/>
