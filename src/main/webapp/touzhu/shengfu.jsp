			...
			<form method="post" action="/jclq/bettingByDipin.do" id="BettingForm" name="BettingForm">		
				<div class="ChannelBuyPannel ChannelBuyCheck">
					...
					<div class="ChannelBuyPannelBody CheckSum">
						...
						<br>
						<input name="" type="button" value="确认代购" class="CastBtn" onclick="openTouzhu();"/>
					</div>
				</div>
				<!-- 选号框-->
				...
				<input type="hidden" name="lotNo" value="J00005" id="lotNo"/>
				...
				<input type="hidden" value="胜负" id="dangqianwanfa"/>
